...
const serviceCards = [
  {
    ...
    outcome:
      "Turn more clicks into calls and quote requests from local buyers.",
  },
  {
    icon: Bot,
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/90 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <Link
            href="/demos"
            className="text-sm font-semibold tracking-wide text-brand-amber"
          >
          ...
          <Button
            asChild
            size="sm"
            className="bg-brand-orange hover:bg-brand-orange-bright text-white"
          >
          ...
          <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:px-8">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-lg text-slate-300">
                We build high-converting websites, AI chatbots, and automations
                for local businesses. Turn your website into a 24/7 sales system
                that captures, qualifies, and follows up with leads while you
                sleep.
              </p>
        ...
        <section className="border-b border-white/10 py-14">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <h2 className="font-serif text-3xl font-bold text-white">
              Why local websites fail — and how we fix it
            </h2>
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              <article className="rounded-2xl border border-red-400/25 bg-red-500/10 p-6">
                ...
                <p className="mt-3 text-sm leading-relaxed text-slate-200">
                  Most local business websites look decent but fail at
                  conversion. Slow load times, weak calls-to-action, and delayed
                  follow-up send ready-to-buy leads to faster competitors.
                </p>
              </article>
              <article className="rounded-2xl border border-brand-orange/30 bg-brand-orange/10 p-6">
                <h3 className="text-lg font-semibold text-white">
                  The Highridge solution
                </h3>
                <p className="mt-3 text-sm leading-relaxed text-slate-100">
                  We combine conversion-centered design, AI chatbots, and
                  automation workflows so every visitor gets a clear next step,
              ...
              {[
                {
                  step: "01",
                  title: "Build",
                  copy: "We design your site around your offer, local audience, and conversion goals.",
                },
                {
                  step: "02",
                  title: "Launch",
                  copy: "We deploy a high-speed, mobile-first site with trust signals and clear CTAs.",
                },
                {
                  step: "03",
                  title: "Automate",
                  copy: "AI chat and workflows capture, route, and follow up with leads automatically.",
                },
              ].map(item => (
                <article
                  key={item.title}
                  className="rounded-2xl border border-white/10 bg-white/5 p-6"
                >
                  <p className="text-3xl font-bold text-brand-orange/80">
                    {item.step}
                  </p>
        ...
        <section id="cta" className="py-16">
          <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-2xl border border-brand-orange/25 bg-gradient-to-br from-brand-orange/20 to-slate-900 p-8 text-center">
              <h2 className="font-serif text-3xl font-bold text-white">
                Ready for a website that sells for you 24/7?
              </h2>
              <p className="mt-3 text-slate-200">
                Get a free demo concept tailored to your business type and local
                market.
              </p>
