            ...
            <div className="flex flex-col gap-7">
              <div className="flex flex-wrap items-center gap-4">
                <div className="flex items-center gap-1.5 bg-brand-orange/10 px-4 py-2.5 rounded-full border border-brand-orange/20">
                  ...
                  <span className="text-[11px] sm:text-xs font-black uppercase tracking-[0.22em] text-white/90">Founder-Led</span>
                </div>
                <div className="h-px w-12 bg-white/10" />
                <span className="text-[10px] sm:text-[11px] uppercase font-bold tracking-[0.18em] text-white/40">Sylva, NC — Contractor Niche Only</span>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm text-white/40 font-medium tracking-wide">
                  Free Beacon Audit · No-pressure consultation · Clear next steps
                </p>
              </div>
            </div>
