      ...
      >
        ...
        <div className="absolute inset-0 bg-[oklch(0.12_0.02_260)]">
          <div className="p-12 h-full flex flex-col justify-center bg-gradient-to-br from-brand-orange/[0.08] to-transparent">
            ...
            <h4 className="text-4xl font-serif font-bold text-white mb-4 tracking-tight">The High Ridge Result</h4>
            <p className="text-xl text-gray-300 max-w-sm mb-10 leading-relaxed font-medium">Clear messaging, fast performance, and trust-centered design.</p>
            ...
            <div className="grid grid-cols-2 gap-6 max-w-md">
              <div className="p-6 bg-white/5 rounded-3xl border border-white/10 flex flex-col items-start gap-2 backdrop-blur-md">
                <span className="text-5xl font-black text-brand-orange">98</span>
                <span className="text-xs uppercase font-bold text-gray-500 tracking-[0.2em]">Optimization</span>
              </div>
              <div className="p-6 bg-white/5 rounded-3xl border border-white/10 flex flex-col items-start gap-2 backdrop-blur-md">
                <span className="text-5xl font-black text-brand-amber">3x</span>
                <span className="text-xs uppercase font-bold text-gray-500 tracking-[0.2em]">Growth</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="p-12 h-full flex flex-col justify-center text-gray-700 bg-white/40 backdrop-blur-sm">
            ...
            <p className="mt-12 text-sm uppercase font-black tracking-[0.4em] text-gray-400/60">Broken & Low Conversion</p>
          </div>
        </div>
        ...
        {/* FIXED LABELS */}
        <div className="absolute bottom-10 left-10 z-30 px-5 py-2.5 bg-black/60 backdrop-blur-xl rounded-xl text-sm text-white uppercase tracking-[0.3em] font-black border border-white/10 shadow-xl">Before</div>
        <div className="absolute bottom-10 right-10 z-30 px-5 py-2.5 bg-brand-orange/80 backdrop-blur-xl rounded-xl text-sm text-white uppercase tracking-[0.3em] font-black border border-white/10 shadow-xl">After</div>
      </div>
      
      {/* Footer Text */}
      <div className="mt-10 text-center">
        <span className="text-xs uppercase font-black tracking-[0.5em] text-white/20">The Transformation System</span>
      </div>
    </div>
  );
}
